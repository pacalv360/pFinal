	...
	public CloudantPalabraStore(){
		...
		try {
			client = ClientBuilder
					.url(new URL("https://86cbd9ed-037b-4e84-8565-ed07ea17daf1-bluemix.cloudantnosqldb.appdomain.cloud"))
					//.account("86cbd9ed-037b-4e84-8565-ed07ea17daf1-bluemix.cloudantnosqldb.appdomain.cloud")
					.username("86cbd9ed-037b-4e84-8565-ed07ea17daf1-bluemix")
					.password("edb3724142f4e7031d9f597a435ad6a69ec10ec47dc91dd0305765177038a7e8")
					.build();
